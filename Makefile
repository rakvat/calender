...
libkalender: kalenderjahr.cs ausgabe.cs htmlausgabe.cs latexausgabe.cs hilfskonstrukte.cs
	gmcs -target:library kalenderjahr.cs ausgabe.cs htmlausgabe.cs latexausgabe.cs eintrag.cs hilfskonstrukte.cs -out:_builds/libkalender.dll
